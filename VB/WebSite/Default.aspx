...
<head runat="server">
    <title>How to bind ASPxGridView to data using data source parameters stored in server session</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <h2>Data source without select parameters</h2>
            <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" OnDataBinding="ASPxGridView1_DataBinding">
            </dxwgv:ASPxGridView>
            <h2>Data source with select parameters</h2>
            <table>
                <tr>
                    <td>
